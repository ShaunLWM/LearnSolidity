...
contract CakeTogether is Ownable, ReentrancyGuard {
  ...
  mapping(address => mapping(uint256 => TicketRange[])) private _userContributionsPerRoundId;
  ...
  function deposit(uint256 _roundId, uint256 _amount) external nonContract nonReentrant {
    ...
    _userContributionsPerRoundId[msg.sender][_roundId].push(userTicketRange);
